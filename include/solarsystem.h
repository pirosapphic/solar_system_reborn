...
// naming convention:
//      - variables are to be named meaningfully, write a name that explains what the "x" is (for this specific situation snake_case is preferred over camelCase): 
//      	mass, width, moon_orbit... 
...
//
//
// Declaration of the class CelestialBody and its methods:
